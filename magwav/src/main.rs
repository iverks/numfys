...
fn task_2_1() {
    ...
    // let mut sys = MagneticSystem::new_toy(na::DMatrix::from_element(1, 1, magnet), 10.0, 1.0);
    let mut sys = MagneticSystem::new_toy(na::DMatrix::from_element(2, 2, magnet), 10.0, 1.0);
